  <?php
    ...
    $query = "SELECT max(kd_posisi) as maxkd_posisi FROM tb_posisi";
    $hasil = mysqli_query($con, $query);
    $data  = mysqli_fetch_array($hasil);
    $kd_posisi = $data['maxkd_posisi'];

    // mengambil angka atau bilangan dalam kode anggota terbesar,
    // dengan cara mengambil substring mulai dari karakter ke-1 diambil 6 karakter
    // misal 'BRG001', akan diambil '001'
    // setelah substring bilangan diambil lantas dicasting menjadi integer
    $noUrut = (int) substr($kd_posisi, 1, 2);
...
<div class="modal-dialog">
    <div class="modal-content">
    	...
    	<div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel">INPUT DATA POSISI PEGAWAI</h4>
        </div>
        ...
        <div class="modal-body">
        	<form action="proses.php" name="modal_popup" method="POST">
                    ...
                    <div class="col-lg-12">
                        <ol class="breadcrumb alert-info">
                            <li class="active" style="font-size: 16px;"">
                                <i class="fa fa-info-circle"></i> Kode Posisi : <b><em><u><?=$newID?></u></em></b>
                            </li>
                        </ol>
                    </div>
                </div> 
                <div class="form-group" style="padding-bottom: 20px;">
                    ...
                    <input type="hidden" readonly name="kd_posisi" id="kd_posisi" class="form-control" value="<?=$newID?>">
                    <input type="text" name="posisi" id="posisi"  class="form-control" required autofocus>
                </div>
